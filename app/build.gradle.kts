...
android {
    namespace = "com.example.xotandroid"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.xotandroid"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
//    implementation(libs.androidx.compose.animation)
    ...
    // file upload
    implementation ("androidx.activity:activity-compose:1.7.0") // ActivityResult support
    implementation ("com.google.accompanist:accompanist-permissions:0.34.0") // Permission
